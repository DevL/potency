...
Depending on the situation, *malus dice* can be subtracted from a roll. At most 3 *malus dice* can be affect a roll though no matter the number of _malus dice_, the [wild die](../Rolling%20Dice/Wild%20Die.md) cannot be eliminated. Indicated as a number followed by the letter ´M´, e.g. 3M.   
